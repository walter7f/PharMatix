...
-- Análisis del Esquema: Proyecto nuevo - sin tablas existentes
-- Tipo de Integración: Nuevo sistema completo de planificación farmacéutica
-- Dependencias: Creando módulo completo de autenticación + planificación
...
-- 5. Calendario Principal de Planificación - Emisión de Lotes
...
-- 6. Asignaciones de Recursos para Lotes
...
-- 7. Eventos del Calendario (incluye mantenimiento, capacitación, auditorías)
CREATE TABLE public.calendar_events (
    ...
    recurring_rule TEXT, -- Regla RRULE para eventos recurrentes
    lot_schedule_id UUID REFERENCES public.lot_schedules(id) ON DELETE CASCADE,
    created_by UUID REFERENCES public.user_profiles(id) ON DELETE SET NULL,
...
-- 9. Funciones Auxiliares (ANTES de las Políticas RLS)
...
-- 11. Políticas RLS (Usando Patrones 1 & 2 de las guías)

-- Patrón 1: Tabla de usuarios principal - Solo simple, sin funciones
...
-- Patrón 2: Propiedad simple de usuario para productos
...
-- Patrón 4: Lectura pública para recursos, escritura de managers
...
-- Patrón 2: Propiedad simple para programación de lotes
...
-- Las asignaciones de recursos siguen los permisos de programación de lotes
...
-- Eventos del calendario - usuarios pueden ver todos, gestionar los propios
...
-- 13. Datos de Prueba con Usuarios de Auth Completos
DO $$
DECLARE
